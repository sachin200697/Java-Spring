        ...
        <form action="handle-add-product" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td><textarea cols="40" rows="5" name="description" id="description">${product.description}</textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td><button><a href="${pageContext.request.contextPath}/">Back</a></button>&nbsp;&nbsp;<input type="submit" value="Edit"/></td>
                </tr>
            </table>
        </form>
    </body>
